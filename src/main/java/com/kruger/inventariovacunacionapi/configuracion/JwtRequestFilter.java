 ...
 */
package com.kruger.inventariovacunacionapi.configuracion;
...
public class JwtRequestFilter extends OncePerRequestFilter{
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
            ...
            try {
                cedula = jwtUtil.getUsernameFromToken(jwtToken);
        ...
        if (cedula != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            UserDetails userDetails = jwtService.loadUserByUsername(cedula);
